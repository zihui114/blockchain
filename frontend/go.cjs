...
try {
  // 載入 ABI
  const factoryAbi = require('../../blockchain-real-estate/out/PropertyTokenFactory.sol/PropertyTokenFactory.json').abi;
  const tokenAbi = require('../../blockchain-real-estate/out/MyPropertyToken.sol/MyPropertyToken.json').abi;
  const daoAbi = require('../../blockchain-real-estate/out/PropertyDAO.sol/PropertyDAO.json').abi;
  const marketplaceAbi = require('../../blockchain-real-estate/out/PropertyMarketPlace.sol/PropertyMarketplace.json').abi;
